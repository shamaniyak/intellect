...
QObject *MemoryCompareProxyModel::sourceMemory() const
{
	return curMem_;
}

void MemoryCompareProxyModel::setSourceMemory(QObject *mem)
{
	if(curMem_ == mem)
		return;
	curMem_ = dynamic_cast<QMemoryModel*>(mem);
	emit sourceMemoryChanged();
}

QObject *MemoryCompareProxyModel::compareMemory() const
{
	return compareMem_;
}

void MemoryCompareProxyModel::setCompareMemory(QObject *mem)
{
	if(compareMem_ == mem)
		return;
	compareMem_ = dynamic_cast<QMemoryModel*>(mem);
