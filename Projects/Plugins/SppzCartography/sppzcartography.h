...
#include "sppzcartography_global.h"
#include <isppzcartographyplugin.h>
#include <imap.h>
...
class SPPZCARTOGRAPHYSHARED_EXPORT SppzCartography : public QObject, public IMap, public ISppzCartographyPlugin
{
  Q_OBJECT
  Q_PLUGIN_METADATA(IID ISppzCartographyPlugin_iid)
  Q_INTERFACES(ISppzCartographyPlugin)
...
private:
  ...
  // ISppzCartographyPlugin interface
public:
